...
def create_class_weight(labels_dict, mu=0.5):
    ...
    for key in keys:
        ...
        print(key, value)
        score = total / value
        score_log = math.log(mu*total / value)
...
x, y = create_class_weight(labels_dict)
print (x)
#input()
...
def main():
    ...
    train_data_list,val_data_list = train_test_split(train_df,test_size = 0.13,random_state = 2050)
    train_data_list_fake,val_data_list_fake = train_test_split(train_df_orig,test_size = 0.01,random_state = 2050)
